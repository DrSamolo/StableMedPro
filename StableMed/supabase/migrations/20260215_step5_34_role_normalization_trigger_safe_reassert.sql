-- =============================================================================
-- STEP 5.34 - Trigger-safe role normalization reassert for manager RLS access
-- =============================================================================

BEGIN;

-- Allow this transaction to update profile roles despite role-update guard trigger.
SELECT set_config('app.allow_invitation_role_sync', 'on', true);

-- Normalize legacy/mixed-case roles so RLS checks (role = 'manager') match reliably.
